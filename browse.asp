...
sub browse {
	...
	my $selstmt = "select t.namespace, t.name, s.one_line, t.topic_num from topic t, statement s where t.replacement is null and t.proposed = 0 and s.replacement is null and t.topic_num = s.topic_num";
;
