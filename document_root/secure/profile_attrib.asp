...
if (! $Session->{'cid'}) { # browsing as guest.
	&display_page('Personal Info', 'Personal Info', [\&identity, \&search, \&main_ctl], [\&advert_for_guest], \&profile_tabs);
	...
	&display_page('Personal Info', 'Personal Info', [\&identity, \&search, \&main_ctl], [\&profile_attrib], \&profile_tabs);
}
